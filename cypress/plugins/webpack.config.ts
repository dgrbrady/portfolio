...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@dgrbrady/ui': path.join(projectRoot, '/libs/ui/src')
    }
  },
  module: {
    rules: [
...
const projectRoot = path.join(__dirname, '../..')
module.exports = {
  entry: path.join(projectRoot, 'apps/desktop/src/main.ts'),
  mode: 'development',
  devtool: 'inline-source-map',
  resolve: {
    extensions: ['.ts', '.js'],
    // modules: [path.join(projectRoot, 'apps/desktop/src/app'), 'node_modules'],
